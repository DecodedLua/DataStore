...
module.exports = class test {
    constructor(){
            this.name = '☑️  Clearshout - RobloxFunctions/shout.js'
            this.alias = ['clearshout']
...
async run(Client, message, args) {
    ...
    const Command = "clearshout"
    const Action = "User has cleared shout"
    ...
    await RobloxFunctions.shout(GroupID, " ").catch(console.error)
