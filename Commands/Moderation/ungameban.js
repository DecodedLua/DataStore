...
module.exports = class test {
    constructor(){
            this.name = '☑️  Ungameban - Moderation/ungameban.js'
            this.alias = ['ungameban']
...
Axios.get(`http://api.roblox.com/users/get-by-username?username=${args[1]}`).then(function (response){
    ...
    .setAuthor(`User unbanned.`, `https://imgur.com/g6q6bOS.png`)
    .setColor(ClientSettings.DefaultColor)
    .setDescription(`[${RobloxName}](${UserProfile}) has been unbanned!`);

    Axios.post("https://script.google.com/macros/s/" + ScriptToken + "?sheet=Global&key=" + RobloxID + "&value=" + false, {});
